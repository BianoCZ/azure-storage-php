...
class TestResources
{
    public const string QUEUE1_NAME   = 'Queue1';
    public const string QUEUE2_NAME   = 'Queue2';
    public const string QUEUE3_NAME   = 'Queue3';
    public const string KEY1          = 'key1';
    public const string KEY2          = 'key2';
    public const string KEY3          = 'key3';
    public const string KEY4          = 'AhlzsbLRkjfwObuqff3xrhB2yWJNh1EMptmcmxFJ6fvPTVX3PZXwrG2YtYWf5DPMVgNsteKStM5iBLlknYFVoA=='; //Faked although looks real.
    public const string VALUE1        = 'value1';
    public const string VALUE2        = 'value2';
    public const string VALUE3        = 'value3';
    public const string ACCOUNT_NAME  = 'myaccount';
    public const string TOKEN_CS      = 'DefaultEndpointsProtocol=https;AccountName=' . self::ACCOUNT_NAME . ';';
    public const string SAS_TOKEN     = 'st=2016-12-01T19%3A43%3A00Z&se=2016-12-02T19%3A43%3A00Z&sp=rwdl&sv=2015-12-11&sr=c&sig=aGVsbG8gd29ybGQ%3D';
    public const string QUEUE_URI     = '.queue.core.windows.net';
    public const string URI1          = "http://myaccount.queue.core.windows.net/myqueue";
    public const string URI2          = "http://myaccount.queue.core.windows.net/?comp=list";
    public const string DATE1         = 'Sat, 18 Feb 2012 16:25:21 GMT';
    public const string DATE2         = 'Mon, 20 Feb 2012 17:12:31 GMT';
    public const string REQUEST_ID1   = 'f16b5298-0003-011e-0e70-83666b000000';
    public const string REQUEST_ID2   = 'c17dcd76-0003-0046-1c70-832445000000';
    public const string RESPONSE_BODY = "<?xml version=\"1.0\" encoding=\"utf-8\"?><Error><Code>InvalidResourceName</Code><Message>The specifed resource name contains invalid characters.\nRequestId:f16b5298-0003-011e-0e70-83666b000000\nTime:2017-02-10T07:36:04.8329883Z</Message></Error>";
    public const string RESPONSE_BODY_JSON = '{"odata.error":{"code":"ResourceNotFound","message":{"lang":"en-US","value":"Test"}}}';
    public const string ERROR_MESSAGE = "The specifed resource name contains invalid characters.\nRequestId:f16b5298-0003-011e-0e70-83666b000000\nTime:2017-02-10T07:36:04.8329883Z";
    public const string VALID_URL     = 'http://www.example.com';
    public const string HEADER1       = 'testheader1';
    public const string HEADER2       = 'testheader2';
    public const string HEADER1_VALUE = 'HeaderValue1';
    public const string HEADER2_VALUE = 'HeaderValue2';
    public const string ENTITY_JSON_STRING = '{"PartitionKey":"123","RowKey":"456","CustomerId":890,"CustomerName":"John","IsNew":true,"IsNew@odata.type":"Edm.Boolean","JoinDate":"2012-01-26T18:26:19.0000470Z","JoinDate@odata.type":"Edm.DateTime","Cost":"12.45","Cost@odata.type":"Edm.Double"}';

    // Media services
    public const string MEDIA_SERVICES_ASSET_NAME             = 'TestAsset';
    public const string MEDIA_SERVICES_OUTPUT_ASSET_NAME      = 'TestOutputAsset';
    public const string MEDIA_SERVICES_ACCESS_POLICY_NAME     = 'TestAccessPolicy';
    public const string MEDIA_SERVICES_LOCATOR_NAME           = 'TestLocator';
    public const string MEDIA_SERVICES_JOB_NAME               = 'TestJob';
    public const string MEDIA_SERVICES_JOB_ID_PREFIX          = 'nb:jid:UUID:';
    public const string MEDIA_SERVICES_JOB_TEMPLATE_NAME      = 'TestJobTemplate';
    public const string MEDIA_SERVICES_JOB_TEMPLATE_ID_PREFIX = 'nb:jtid:UUID:';
    public const string MEDIA_SERVICES_TASK_COFIGURATION      = 'H.264 HD 720p VBR';
    public const string MEDIA_SERVICES_PROCESSOR_NAME         = 'Windows Azure Media Encoder';
    public const string MEDIA_SERVICES_DECODE_PROCESSOR_NAME  = 'Storage Decryption';
    public const string MEDIA_SERVICES_PROCESSOR_ID_PREFIX    = 'nb:mpid:UUID:';
    public const string MEDIA_SERVICES_DUMMY_FILE_NAME        = 'simple.avi';
    public const string MEDIA_SERVICES_DUMMY_FILE_CONTENT     = 'test file content';
    public const string MEDIA_SERVICES_DUMMY_FILE_NAME_1      = 'other.avi';
    public const string MEDIA_SERVICES_DUMMY_FILE_CONTENT_1   = 'other file content';
    public const string MEDIA_SERVICES_ISM_FILE_NAME          = 'small.ism';
    public const string MEDIA_SERVICES_ISMC_FILE_NAME         = 'small.ismc';
    public const string MEDIA_SERVICES_STREAM_APPEND          = 'Manifest';
    public const string MEDIA_SERVICES_INGEST_MANIFEST        = 'TestIngestManifest';
    public const string MEDIA_SERVICES_INGEST_MANIFEST_ASSET  = 'TestIngestManifestAsset';
    public const string MEDIA_SERVICES_CONTENT_KEY_AUTHORIZATION_POLICY_NAME     = 'TestContentKeyAuthorizationPolicy';
    public const string MEDIA_SERVICES_CONTENT_KEY_AUTHORIZATION_OPTIONS_NAME    = 'TestContentKeyAuthorizationPolicyOption';
    public const string MEDIA_SERVICES_CONTENT_KEY_AUTHORIZATION_POLICY_RESTRICTION_NAME = 'TestContentKeyAuthorizationPolicyRestriction';
    public const string MEDIA_SERVICES_ASSET_DELIVERY_POLICY_NAME = 'AssetDeliveryPolicyName';
    ...
    public static function getContainerAclMultipleEntriesSample()
    {
        ...
        $sample['SignedIdentifiers'] = [
            'SignedIdentifier' => [
                0 => [
                    'Id' => 'HYQzNDU2Nzg5MDEyMzQ1Njc4OTAxMjM0NTY3ODkwMTI=',
                    'AccessPolicy' => [
                        'Start' => Utilities::convertToEdmDateTime(self::getRandomEarlierTime()),
                        'Expiry' => Utilities::convertToEdmDateTime(self::getRandomLaterTime()),
                        'Permission' => 'wd',
